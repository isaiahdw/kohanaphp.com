...
<div id="rotator">
	...
	<ul id="slides">
		...
		<li>
			<img src="<?php echo URL::base(TRUE) ?>media/img/overview_strictphp.png" alt="Strict PHP 5 OOP" />
...
<div id="downloadKohana">
	<div id="dwlKo2">
		...
		<div class="downloadButton">
			<a href="<?php echo url::base().'download?get='.$versions['ko2']['version'] ?>"><img src="<?php echo URL::base(TRUE) ?>media/img/icons/16/disk.png"/> Download Version <?php echo $versions['ko2']['version'] ?></a>
		</div>
	</div>
	<div id="dwlKo3">
		<h2>Kohana 3.x</h2>
		...
		<div class="downloadButton">
			<a href="<?php echo url::base().'download?get='.$versions['ko3']['version'] ?>"><img src="<?php echo URL::base(TRUE) ?>media/img/icons/16/disk.png"/> Download Version <?php echo $versions['ko3']['version'] ?></a>
		</div>
	</div>
	<hr class="cleaner"/>
</div>
